-- Fieles Bienes — Migración inicial (v1)
-- Compatible SQLite 3.x | PRAGMA foreign_keys debe estar ON al aplicar
...
-- =============================================================================
-- Agregados, sincronización y reportes
-- =============================================================================
...
-- =============================================================================
-- Índices (performance CTE, filtros masivos, sync delta)
-- =============================================================================
...
-- Parroco: inventario, ofrendas, organizaciones, usuarios, sync, reportes
INSERT OR IGNORE INTO role_modulos (role_id, modulo_id) VALUES
...
-- EncargadoCapilla: organizaciones (lectura), inventario, ofrendas, sync
INSERT OR IGNORE INTO role_modulos (role_id, modulo_id) VALUES
